...
$my_email = "ajayreddy@adsellsolutions.com";
...
if(count($errors)){foreach($errors as $value) header("Location: http://www.adsellsolutions.com/?q=failure#contact");exit;}
...
header("Location: http://www.adsellsolutions.com/?q=success#contact");
die();
?>
