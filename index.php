			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right custom-menu">
						<li class="active"><a href="http://www.adsellsolutions.com/#home"><b>Home</b></a></li>
						<li><a href="#about"><b>About</b></a></li>
						<li><a href="#services"><b>Services</b></a></li>
						<li><a href="#meet-team"><b>Team</b></a></li>
						
						<li><a href="#contact"><b>Contact</b></a></li>
						<li><a href="http://www.adsellsolutions.com/blog/newblog/"><b>Blog</b></a></li>
						</ul>
				</div>
			</div>
		</nav>
...
<a href="#services"><br><i class="fa fa-arrow-circle-left fa-3x" style=' float: left;'></i></a>
		...
		<div class="col-md-6">
				<br>
				<br><br>
                <img class="img-responsive3" src="images/cw1.jpg" alt="">
            </div>
		<div class="col-md-6" style="color:white;font-size:medium;">	<div class="img-responsive3"><br><br><br><br></div><b>Creating lucid and innovative content for your company for maximum visibility across all platforms</b> <br>
In order to attract customers from all over the globe, it is vital to have clear and concise content that best defines your company, delivered to the masses on all platforms and forums conducive to growth. We at ADSELLS assign a dedicated writing team that develops content based on real-time client interactions and current trends aimed at carving a niche in the market for your enterprise.
	...
	<a href="#services"><br><i class="fa fa-arrow-circle-left fa-3x" style=' float: left;'></i></a>
		...
		<div class="col-md-6">
				<br>
				<br><br>
                <img class="img-responsive3" src="images/cm1.jpg" alt="">
            </div>
		<div class="col-md-6" style="color:white;font-size:medium;"><div class="img-responsive3"><br><br><br><br></div><b>Delivering your vision to your target customers through effective marketing solutions.</b><br>
...
<div class = 'hd-det'id="detail_flex"class="orangeback">
	...
	<a href="#services"><br><i class="fa fa-arrow-circle-left fa-3x" style=' float: left;'></i></a>
		...
		<div class="col-md-6">
				<br>
				<br><br>
                <img class="img-responsive3" src="images/pa1.jpg" alt="">
            </div>
		<div class="col-md-6" style="color:white;font-size:medium;"><div class="img-responsive3"><br><br><br><br></div>A product that has the potential to take the industry by storm, necessitates appropriate material that delivers it to the world. ADSELLS doesn’t just advertise your product. We ensure that it sells. </div>
		</div>
		</div>
</div>
<div class = 'hd-det'id="detail_strat1"class="orangeback">
	...
	<a href="#services"><br><i class="fa fa-arrow-circle-left fa-3x" style=' float: left;'></i></a>
		...
		<div class="col-md-6">
				<br>
				<br><br>
                <img class="img-responsive3" src="images/ns1.jpg" alt="">
            </div>
		<div class="col-md-6" style="color:white;font-size:medium;"><div class="img-responsive3"><br><br><br><br></div>ADSELLS transforms your company into a collaborative global consortium of like-minded entities using a vast network of investors and clientele, offering a low-cost, quick-fire solution for sales opportunities.</div>
		</div>
		</div>
	...
	<a href="#services"><br><i class="fa fa-arrow-circle-left fa-3x" style=' float: left;'></i></a>
		...
		<div class="col-md-6">
				<br>
				<br><br>
                <img class="img-responsive3" src="images/video1.jpg" alt="">
            </div>
		<div class="col-md-6" style="color:white;font-size:medium;"><div class="img-responsive3"><br><br><br><br></div>If a picture speaks a thousand words, an attractive video sells a million times more. ADSELLS creates both digital animation and live-action videos to market your product in a highly feasible manner, breaking traditional norms of corporate boundaries to infuse life into your product.  </div>
		</div>
		</div>
</div>
				...
				<div class="col-md-2"></div>
					...
					<div class="col-xs-12 col-sm-6 col-md-4">
						<div class="team-member">
							...
							<p>Ajay Reddy serves as Chief marketing officer at Adsells. An engineer by education, he has a keen interest in marketing and management, and shares the same zeal for promoting the startup culture in the country. He is the head of the ADSELLS marketing team and is responsible for laying out the marketing and advertising plans for clients’ products and services.</p><div class="img-responsive3"><br><br></div>
							<ul class="social-icons">
							...
							<div class="row">
								...
								<div class="col-md-12 height-contact-element">    
									<div class="form-group">
										...
										<span class="text">kushagragandhi@adsellsolutions.com</span>
									</div>
									<div class="form-group">
										<i class="fa fa-2x fa-envelope"></i>
										<span class="text">ajayreddy@adsellsolutions.com</span>
									</div>
								</div>
								<div class="col-md-12 contact-msg">
									<div class="col-md-12 text-center" id="success" style=<?php 
												if($_GET["q"]=="success")
													echo '"display:block;"';
												else 
													echo '"display:none;"';
